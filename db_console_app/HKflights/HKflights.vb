...
Module HKflights
    ...
    Sub FlightsUpdate()
        Dim d As Date
        d = Today.AddDays(-7)
        Do Until d > Now.AddDays(14).AddHours(-4)
            '2025-07-28 reducing "flights not found" errors by subtracting 4 hours so that the 14th day ahead is not loaded until 04:00
            Call GetFlights(d)
            d = d.AddDays(1)
        Loop
    End Sub
