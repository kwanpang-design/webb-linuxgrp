	...
	<div id="srchblk" style="background-color:inherit;">
		<div class="box4">
			...
			<form class="box4a" method="get" action="https://www.google.com/search">
				...
				<input type="hidden" name="domains" value="webb-site.linuxgrp.com">
				<input type="hidden" name="sitesearch" value="webb-site.linuxgrp.com">
				<input type="text" class="inptxt searchws" name="q" maxlength="255" value="search webb-site.linuxgrp.com" onclick="value=''">
...
<div id="menubar" style="background-color:maroon;">
	<div class="hnav">
		...
		<ul>
			...
			<li><a href="https://webbhk.substack.com/" target="_blank">Webb-site Reports</a></li>
