...
of holdings may be frozen. Temporary counters and parallel trading have been an anachronism since CCASS 
	...
	<li>Effective 30-Jun-2025, stocks with additional counters traded in CNY or USD (multi-counter stocks) are all 
	booked on the primary HKD counter in CCASS, so there are no CCASS records for those counters from that date onwards. 
	They should have just done this from the begining: whatever currency you exchange for a stock, you still own the 
	same stock.</li>
